    ...
    >
      ...
      >
        ...
        <div className="absolute-cover z-30">
          ...
          {/* <div
            className="h-1/3 absolute bottom-0 w-full tracking-tight font-geist text-sm"
            style={{
          ...
          <div className="h-1/3 relative px-3 pt-3 flex justify-between items-center">
            ...
            <div className="text-C">
              <h2
                ...
                style={{ ...embossStyle, fontSize: getFontSize(5.5) }}
              >
                {data.passName}
              </h2>
            </div>
        ...
        <div className="absolute w-full top-1/3 bottom-1/3 flex justify-center items-center text-C z-30">
          <p
            ...
            style={{ ...embossStyle, fontSize: getFontSize(6.4) }}
          >
            {data.userName}
          </p>
        </div>
